...
public class StackImplementation {
	...
	public static void main(String[] args) {
		...
		System.out.println("The topmost element int stack before deletion is: "+stack1.peek());
		
		//delete the top element from stack
		stack1.pop();
		
		//print the top most element from the stack
		System.out.println("The top most element in the stack after deletion is : "+stack1.peek());
